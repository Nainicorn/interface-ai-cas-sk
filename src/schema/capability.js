 ...
 * is why the base URL lives in config/<app>/config.json rather than in the recording.
 */
export const CapabilitySchema = z.object({
  ...
  target: z.object({
    app_id: z.string().min(1).describe('App key; resolved via config/<app>/config.json'),
